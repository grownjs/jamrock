import {
  raf, view, mount, patch, onError, useRef, useMemo, useState, useEffect,
} from 'somedom';

import { $, $$, registerComponent } from './thunks';
...
Browser._ = {
  $, $$, js, css, set, dom, raf, log, warn, sync, view, lookup, onError, useRef, useMemo, useState, useEffect, renderSync, registerComponent,
};
