...
- [ ] Fix GTK4 Explorer crash with 50+ widgets (Bus error: 10) — unicode/emoji in GTK4 labels confirmed root cause; `playground/gallery.html`, `notifications.gtk.mjs`, `todo.gtk.mjs`, `calculator.gtk.mjs` still have unicode labels; Explorer blocklist at `lib/gtk4/explorer.js:299`
