export { vars as variables } from 'eslint-plugin-jamrock/util.js';

import reExport from 'rewrite-exports';
import { imports } from '../shared/utils.js';
...
export function transform(self, props, loader, prelude, callback) {
  ...
  code = imports(code, loader.replace(RE_UNSAFE_DOLLAR, '$$$$')).replace(_require, (_, _vars, source) => {
  ...
  code = code.replace(RE_UNSAFE_REQUIRE, 'await import');
